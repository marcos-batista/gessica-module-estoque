...
@RestController
@RequestMapping("/orcamentovenda")
@CrossOrigin
public class OrcamentoVendaResource extends DataObjectResourceControllerImpl<OrcamentoVenda> {
	...
	public OrcamentoVenda doPut(@PathVariable(value = "id") String id, @RequestBody OrcamentoVenda orcamentoVenda) {
